    ...
    <div class="ui container">
        <div class="ui grid">
            <div class="column">
                ...
                <p class="text-fade">Need help checkout these quick help, if your problem still not solved you can contact <a href="mailto:admin@vocit.info">admin@vocit.info</a></p>
            </div>
        </div>
        <div class="ui grid">
            <div class="column">
