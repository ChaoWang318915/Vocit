<header class="ui container-fluid">
    <div class="ui three column grid">
        ...
        <div class="column text-right" style="vertical-align: middle">
...
{{--                            <a href="{{url($user->active_business->subdomain .'/wallet')}}" class="item">{{ucwords($user->active_business->name)}} Wallet</a>--}}
                        @else
