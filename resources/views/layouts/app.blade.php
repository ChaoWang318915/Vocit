...
<div id="app">
    ...
    <main>
        ...
        <div class="ui mini modal info-modal">
            <div class="content">
                <p>You are giving the marketing rights of this picture to the business in exchange for a reward. The picture will also be posted on Vocit Home Page and your Facebook page. Do you agree?</p>
            </div>
            <div class="actions">
...
<script>
  window.fbAsyncInit = function() {
    FB.init({
      appId            : '325510271854636', //'891941987965583',
